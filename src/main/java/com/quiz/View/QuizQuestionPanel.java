...
public class QuizQuestionPanel extends GlassPanel {
        ...
        public QuizQuestionPanel(ArrayList<String[]> questionData) {
                ...
                scrollPane.setBounds(scrollPaneX, scrollPaneY, scrollPaneWidth, scrollPaneHeight); // Set the bounds
                                                                                                   // dynamically
                ...
                editButton.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                                ...
                                for (int i = 0; i < tableModel.getRowCount(); i++) {
                                        ...
                                        if (questionValue.equals(questionTextField.getText())) {
                                                ...
                                                tableModel.setValueAt(selectedSubject, i, 0); // Assuming subject is in
                                                                                              // the
                                                // first column (index
                                                // 0)
                                                tableModel.setValueAt(questionTextField.getText(), i, 1);
