...
public class AllScoreView extends GlassPanel {
    ...
    public AllScoreView(ArrayList<String[]> scoreData) {
        ...
        ModernButton addButton = new ModernButton("Add Score");
        addButton.setBounds(950, 500, 310, 35);
        add(addButton);
        ModernButton editButton = new ModernButton("Edit");
        editButton.setBounds(950, 555, 150, 35);
        add(editButton);
        ...
        deleteButton.setBounds(1110, 555, 150, 35);
        add(deleteButton);
